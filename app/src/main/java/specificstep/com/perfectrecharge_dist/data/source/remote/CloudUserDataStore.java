package specificstep.com.perfectrecharge_dist.data.source.remote;
...
import specificstep.com.perfectrecharge_dist.interactors.UserDataMapper;
...
public class CloudUserDataStore implements UserDataStore {
    ...
    @Override
    public Observable<List<UserList>> getChildUsers() {
        return restApi.getChildUsers()
    ...
    @Override
    public Observable<String> addBalance(String userId, String amount) {
        return restApi.addBalance(userId, amount);
    }
