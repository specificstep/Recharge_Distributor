...
import specificstep.com.perfectrecharge_dist.interactors.usecases.ForgotChangePasswordUseCase;
...
public class ForgotPasswordPresenter implements ForgotPasswordContract.Presenter {
    ...
    @Override
    public void onChangePasswordButtonClicked(Context context,String forgot_otp, String password, String oldPassword) {
        callChangePasswordAPI(context,forgot_otp,password,oldPassword);

    }

    private void callChangePasswordAPI(final Context context, String forgot_otp, String password, String oldPassword) {
