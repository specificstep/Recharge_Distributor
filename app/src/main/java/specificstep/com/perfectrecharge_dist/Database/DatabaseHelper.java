...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String CREATE_TABLE_USER_LIST = "CREATE TABLE " + TABLE_USER_LIST + "(" +
                KEY_ID + " INTEGER PRIMARY KEY, username TEXT, phone_no TEXT, email TEXT, usertype TEXT)";
        // new table
//        String CREATE_TABLE_USER_LIST = "CREATE TABLE " + TABLE_USER_LIST + "(" +
...
//        String upgradeQuery = "ALTER TABLE " + TABLE_USER_LIST + " ADD COLUMN firmName TEXT";
